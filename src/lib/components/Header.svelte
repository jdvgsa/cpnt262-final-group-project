<header class="flex bg-slate-800 items-center justify-between">
  ...
  <h1 class="text-white font-bold  hover:underline cursor-pointer text-2xl mt-1"><a href="/">Puck Poetry</a></h1>
  <a href="/"><img class="w-10" src="/images/LOGO.svg" alt="Site-Logo"></a>
  </div>
  <nav class="p-5">
